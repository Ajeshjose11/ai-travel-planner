/* DomeGallery.jsx - interactive 3D image dome gallery */
/* Based on React Bits example, adapted for this project */
...
const DEFAULT_IMAGES = [
  ...
  {
    src: "https://images.unsplash.com/photo-1518391846015-55a9cc003b25?q=80&w=1200&auto=format&fit=crop",
    alt: "New York City",
  },
  {
  ...
  {
    src: "https://images.unsplash.com/photo-1516483642777-4446975dc6b4?q=80&w=1200&auto=format&fit=crop",
    alt: "Cinque Terre",
  },
  {
    src: "https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?q=80&w=1200&auto=format&fit=crop",
    alt: "Kyoto Golden Pavilion",
  },
  {
  ...
  {
    src: "https://images.unsplash.com/photo-1528728329032-2972f65dfb3f?q=80&w=1200&auto=format&fit=crop",
...
function buildItems(pool, seg) {
  ...
  // Use all images and loop if needed, but the user asked for very little duplication.
  // We'll use the provided pool and loop it to fill the slots.
  ...
  useEffect(() => {
    ...
    const close = () => {
      ...
      animatingOverlay.style.cssText =
        "position:absolute;z-index:9999;border-radius:var(--enlarge-radius,32px);overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,.35);transition:all " +
        enlargeTransitionMs +
    ...
    >
      <main ref={mainRef} className="sphere-main">
        <div className="stage">
          <div 
            ref={sphereRef} 
            className={`sphere ${autoRotate && !draggingRef.current && !openingRef.current ? "animate-auto-rotate" : ""}`}
          >
            {items.map((it, i) => (
              <div
                key={`${it.x},${it.y},${i}`}
